...
import com.sicoapp.localrestaurants.data.map.InfoWindowData
...
class CustomInfoWindowGoogleMap(val mapfrag: MapFragment) : GoogleMap.InfoWindowAdapter {
    ...
    override fun getInfoContents(marker: Marker?): View {
        ...
        val mInfoView = (mapfrag.requireActivity() as Activity).layoutInflater.inflate(R.layout.fragment_custum_map, null)
